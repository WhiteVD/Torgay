...
namespace Torgay.Server.Controllers
{
        ...
        : BaseApiController(logger, mapper)
    {
        ...
        public async Task<IActionResult> GetRoleById(string id)
        {
            ...
            if (!(await authorizationService.AuthorizeAsync(User, appRole?.Name ?? string.Empty,
        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            if (appRole.Name?.Equals(_publicRoleName, StringComparison.OrdinalIgnoreCase) == true)
            {
                AddModelError($"Default public role \"{_publicRoleName}\" cannot be deleted");
            }
            else
            {
        ...
        {
            var role = loadRelatedEntities ? await userRoleService.GetRoleLoadRelatedAsync(roleName)
