...
import { Component, OnInit, AfterViewInit, OnDestroy, ViewChildren, QueryList, inject } from '@angular/core';
...
@Component({
    ...
    imports: [
        FormsModule, ReactiveFormsModule, MatFormField, MatLabel, MatInput, MatError, MatButton, MatProgressSpinner,
        MatAnchor, RouterLink, MatIcon, UpperCasePipe, TranslateModule
    ]
})
