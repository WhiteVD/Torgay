...
export class AlertService {
  ...
  showDialog(title: string, message: string, type: DialogType, okCallback: (val?: string) => void): void;
  showDialog(title: string, message: string, type: DialogType, okCallback?: ((val?: string) => void) | null, cancelCallback?: (() => void) | null, okLabel?: string | null, cancelLabel?: string | null, defaultValue?: string | null): void;
  showDialog(title: string, message: string, type?: DialogType, okCallback?: (val?: string) => void, cancelCallback?: () => void, okLabel?: string, cancelLabel?: string, defaultValue?: string) {
    if (!type) {
