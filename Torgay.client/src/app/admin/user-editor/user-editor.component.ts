import { Component, OnDestroy, ViewChild, Input, OnChanges, NgZone, inject, viewChild } from '@angular/core';
...
import { FloatLabelType, MatFormField, MatLabel, MatError } from '@angular/material/form-field';
...
@Component({
    ...
    imports: [
        FormsModule, ReactiveFormsModule, NgClass, MatFormField, MatLabel, MatInput, MatButton, MatError, MatSelect,
        MatOption, MatTooltip, MatCheckbox, MatIcon, TranslateModule
    ]
})
export class UserEditorComponent implements OnChanges, OnDestroy {
  ...
  private getEditedUser(): UserEdit {
    ...
    return {
      ...
      friendlyName: (formModel as UserEdit).friendlyName,
