...
@Component({
    ...
    imports: [
        FormsModule, ReactiveFormsModule, MatFormField, MatLabel, MatInput, MatError, MatExpansionPanel,
        MatExpansionPanelHeader, MatExpansionPanelTitle, MatSlideToggle, MatTooltip, TranslateModule, GroupByPipe
    ]
})
export class RoleEditorComponent implements OnChanges {
  ...
  @Input() role = new Role();
  readonly allPermissions = input<Permission[]>([]);
